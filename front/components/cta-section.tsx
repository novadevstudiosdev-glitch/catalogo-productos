  ...
  return (
    <section className="bg-foreground py-20 sm:py-24">
      <div className="mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
        <h2 className="text-3xl font-bold tracking-tight text-primary-foreground sm:text-4xl">¿Listo para empezar a comprar?</h2>
        ...
        <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
          ...
          <Link href="/productos" className="inline-flex items-center justify-center rounded-md border border-gray-600 px-8 py-3 text-sm font-semibold text-primary-foreground transition-colors hover:bg-gray-800">
            Ver Productos
          </Link>
        </div>
      </div>
